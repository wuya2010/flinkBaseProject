package com.yld.fwarehourse.kafkaproducer;
...
import static com.yld.fwarehourse.kafkaproducer.RondomDate.randomDate;
    ...
    public static class MemberLog {
        ...
        public static GdmMember generateLog(String uid) {
            ...
            String birthday = new SimpleDateFormat("yyyy-MM-dd")
                    .format(randomDate("1960-01-01 00:00:00", "2000-01-01 00:00:00"));
