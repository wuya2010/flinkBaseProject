...
import com.yld.fwarehourse.util.{DataSourceUtil, ParseJsonData}
...
class DimGreenplumAsyncFunction extends RichAsyncFunction[String, String] {
  ...
  override def open(parameters: Configuration): Unit = {
    ...
    client = CuratorFrameworkFactory.newClient("hadoop101:2181,hadoop102:2181,hadoop103:2181", retryPolicy)
    client.start()
